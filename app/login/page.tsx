...
function LoginInner() {
  ...
  return (
    <div className="center-card card">
      <h2>Вход</h2>
      <p className="sub">Чтобы зарегистрироваться на марафон, войди через Google.</p>
      <button className="google-btn" onClick={() => signIn("google", { callbackUrl })}>
        <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden="true">
          ...
          <path fill="#4CAF50" d="M24 44c5.2 0 10-2 13.6-5.2l-6.3-5.2C29.2 35.2 26.7 36 24 36c-5.3 0-9.7-3.1-11.3-7.9l-6.5 5C9.5 39.6 16.2 44 24 44z" />
